...
Revision ID: 1bafc09230a1
Revises: 
Create Date: 2018-02-04 06:45:47.953277
...
def upgrade():
    ...
    sa.Column('isValid', sa.Boolean(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('seekername', sa.String(length=32), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    sa.Column('desc_experience', sa.String(length=256), nullable=True),
    ...
    sa.Column('resume_up', sa.String(length=256), nullable=True),
